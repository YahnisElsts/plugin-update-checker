...
if ( !class_exists(GitLabApi::class, false) ):
	...
	class GitLabApi extends Api {
		...
		public function getLatestRelease() {
			...
			if ( $this->releasePackageEnabled && isset($release->assets, $release->assets->sources) ) {
				/**
				 * Use the first asset SOURCE that is a zip format file generated by a Gitlab Release Pipeline
				 *
