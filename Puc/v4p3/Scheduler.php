<?php
if ( !class_exists('Puc_v4p3_Scheduler', false) ):

	/**
	 * The scheduler decides when and how often to check for updates.
	 * It calls @see Puc_v4p3_UpdateChecker::checkForUpdates() to perform the actual checks.
	 */
	class Puc_v4p3_Scheduler {
		 ...
		 *
		 * @param Puc_v4p3_UpdateChecker $updateChecker
