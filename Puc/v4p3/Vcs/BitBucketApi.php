<?php
if ( !class_exists('Puc_v4p3_Vcs_BitBucketApi', false) ):

	class Puc_v4p3_Vcs_BitBucketApi extends Puc_v4p3_Vcs_Api {
		/**
		 * @var Puc_v4p3_OAuthSignature
		 */
		private $oauth = null;
		...
		public function setAuthentication($credentials) {
			...
			if ( !empty($credentials) && !empty($credentials['consumer_key']) ) {
				$this->oauth = new Puc_v4p3_OAuthSignature(
